...
if (!class_exists('InstallRequirements'))
{
	define('FRAMEWORK_NAME', 'framework');
	
	/**
	 * This class is copy-pasted from framework/dev/install/install.php5
	 * Modifications:
	 *  - Rewritten getBaseDir() method to fix a bug
	...
	class InstallRequirements
	{
		...
		public function check()
		{
			...
			$this->requireFile(FRAMEWORK_NAME . '/dev/install/config-form.html', array(
				"File permissions",
		...
		{
			// MODIFICATION: The original code would prefix the directory path with a surplus 'framework/' prefix. Override the original code.
			// Original:
			...
			// Do it another way: (because we now have the full application loaded, we can use the Director class, which was not available for the installation script.)
			return Director::baseFolder() . DIRECTORY_SEPARATOR;
		}
